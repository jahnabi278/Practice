...
public class PracticeStream {
	...
	public static void main(String[] args) {
		...
		char[] ar = { 'a', 'b', 'b', 'a', 'c', 'd', 'e', 'e', 'd', 'e' };
		Map<Character, Long> map = IntStream.range(0, ar.length).mapToObj(i -> ar[i])
				.collect(Collectors.groupingBy(c -> c, Collectors.counting()));
		map.forEach((charcter, frequency) -> System.out.println("" + charcter + " : " + frequency));
